    ...
    <div class="request">
        <div class="center">
            ...
            <div class="shell_btn_repair">
                <button class="btn_tab button_washer" onclick="openTab(event, 'washer')" id="defaultOpen">стиральные машины</button>
                <button class="btn_tab button_dishwasher" onclick="openTab(event, 'dishwasher')">посудомоечные машины</button>
                <button class="btn_tab button_fridge"onclick="openTab(event, 'fridge')">холодильники</button>
            </div>
            ...
            <div class="request_grid_cover repair_washer">
                <form action="php/order.php" method="post">
                    ...
                    <div class="checkbox_grid" id="washer">
                        ...
                        <label class="checkbox">
                            <input name="form_1[]" type="checkbox" data-price="100" value="Другая">
                            <span>Другая</span>
                        </label>
                    </div>
                    ...
                    <div class="request_col">
                        ...
                        <div class="call_us">
                            или позвоните нам
                            <div class="phone">+7 (343) 254-57-78</div>
                        </div>
                    </div>
                </form>
            </div>
